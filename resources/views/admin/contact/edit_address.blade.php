                    ...
                    <div class="matter-row" class="matter-accordian">
                        <div id="accordion">
                            <div class="card">
                                ...
                                <form action="{{ route('admin.contact.edit.address.action', $details->address_id) }}" method="post">
                                @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group reperiod">
                                                    ...
                                                    <input type="text" name="area_location" id="area_location" class="form-control" value="{{ $details->location }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group reperiod">
                                                    ...
                                                    <input type="text" name="address_line_1" id="address_line_1" value="{{ $details->address_line_1 }}" class="form-control">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group reperiod">
                                                    ...
                                                    <input type="text" name="address_line_2" id="address_line_2" value="{{ $details->address_line_2 }}" class="form-control">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group reperiod">
                                                    ...
                                                    <input type="text" name="state" class="form-control"
                                                        id="exampleSelectexpense" value="{{ $details->state }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group reperiod">
                                                    ...
                                                    <input type="text" name="city" class="form-control"
                                                        id="exampleSelectexpense" value="{{ $details->city }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group reperiod">
                                                    ...
                                                    <input type="text" name="zip_code" class="form-control"
                                                        id="exampleSelectexpense" value="{{ $details->zip }}">
